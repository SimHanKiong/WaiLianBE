...
async def update_enquiry(
    ...
    if enquiry_in.home_postal_code:
        enquiry_dict["home_address"] = get_address(enquiry_in.home_postal_code)
    if enquiry_in.am_postal_code:
        enquiry_dict["am_address"] = get_address(enquiry_in.am_postal_code)
    if enquiry_in.pm_postal_code:
        enquiry_dict["pm_address"] = get_address(enquiry_in.pm_postal_code)
